package com.example.backgroundlocationtrial;
...
public class BackgroundService extends Service {
    ...
    private static final String EXTRA_STARTED_FROM_NOTIFICATION = "com.example.backgroundlocationtrial"+
    ...
    public void onCreate() {
        ...
        locationCallback = new LocationCallback(){
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                Log.d("mylog", "Lat is: " + mLocation.getLatitude() + ", "
                + "Lng is: " + mLocation.getLongitude());
                /*Intent i = new Intent("Coords");
        ...
        HandlerThread handlerThread = new HandlerThread("Drozan");
        handlerThread.start();
    ...
    public void removeLocationUpdates() {
        ...
        }catch (SecurityException ex)
        {
            ...
            Log.e("Err1", "Lost location permission.Could not remove updates. "+ex);
        }
    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Location>() {
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            if (task.isSuccessful() && task.getResult() != null)
                                ...
                                Log.e("Err1", "Failed to get location");
                        }
                    });
        }catch (SecurityException ex)
        {
            Log.e("Err1", "Lost location permission. "+ex);
        }
    }
    ...
    private void onNewLocation(Location lastLocation) {
        ...
        if (servicesIsRunningInForeground(this))
    ...
    private boolean servicesIsRunningInForeground(Context context) {
